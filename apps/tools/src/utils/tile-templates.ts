...
export const tileTemplates: Record<TerrainType, PixelTemplate[][]> = {
  ...
  [Terrain.Wood]: [
    [
      { x: 0, y: 4, width: 16, height: 1 },
      { x: 0, y: 9, width: 16, height: 1 },
      { x: 0, y: 14, width: 16, height: 1 },
      { x: 6, y: 1, width: 2, height: 1 },
      { x: 11, y: 11, width: 2, height: 1 },
    ],
    [
      { x: 0, y: 4, width: 16, height: 1 },
      { x: 0, y: 9, width: 16, height: 1 },
    ...
    [
      ...
      { x: 13, y: 6, width: 2, height: 1 },
      { x: 7, y: 12, width: 3, height: 1 },
    ],
    [
      { x: 0, y: 4, width: 16, height: 1 },
      { x: 0, y: 9, width: 16, height: 1 },
    ...
    [
      ...
      { x: 12, y: 11, width: 3, height: 1 },
    ],
    [
      { x: 0, y: 4, width: 16, height: 1 },
      { x: 0, y: 9, width: 16, height: 1 },
      { x: 0, y: 14, width: 16, height: 1 },
      { x: 7, y: 2, width: 3, height: 1 },
