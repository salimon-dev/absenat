# Agent Rules & Project Context: Absenat

This file is the primary source of truth for any AI working on this project.
...
- `npm run generate-tiles`: Regenerate the world tilemap.
...
---
*Note: Always refer to this file for project-specific constraints.*
